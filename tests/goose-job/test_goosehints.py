...
class GuardrailsTest(unittest.TestCase):
    def test_extension_manager_budget(self):
        ...
        self.assertIn("--content -", GUARDRAILS)
        self.assertIn("quoted heredoc", GUARDRAILS)
        self.assertIn("buzz --help", GUARDRAILS)
        self.assertIn("buzz mem", GUARDRAILS)
        self.assertIn("buzz-cloud-agents", GUARDRAILS)
        self.assertIn("stored pending", GUARDRAILS)
...
class GoosehintsTest(unittest.TestCase):
    def test_session_context_only(self):
        ...
        self.assertIn("--content -", HINTS)
        self.assertIn("quoted heredoc", HINTS)
        ...
        self.assertIn("stored pending", HINTS)
